...
export default function Header() {
  ...
  return (
    <header className=" body-font w-full bg-black font-semibold text-white h-auto max-md:h-20">
        <div className="container mx-auto flex flex-wrap  flex-col md:flex-row items-center md:justify-between max-md:flex-col  max-md:p-0">


          <div className=" flex justify-between max-md:w-full p-5">
          <a href="https://affotax.com">
            ...
            <button className="bg-[#ff7f45] hidden  p-2 rounded-md active:scale-90 w-[10%] max-md:flex justify-center items-center" onClick={handleNav}>
          ...
          <nav className={`flex flex-wrap items-center text-base  justify-center  max-lg:flex-col max-lg:gap-2 transition-all max-md:bg-black max-md:pt-5  max-md:w-full ${isMobileNav ? 'max-md:-translate-x-0' : 'max-md:-translate-x-[-1000px]'}`}>
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer">Home</a>
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer">Pricing</a>
            <div lassName="mr-5 hover:text-[#ff7f45] hover:cursor-pointer relative " >
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer"  onMouseLeave={noSubMenuHandler} onMouseOver={showSubMenuHandler}>Services
                
            </a>
            {showSubMenu ? <ul className="absolute flex flex-col translate-y-2 rounded-md "> 
            {
                    subMenu.map((el) => {
            ...
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer">Blog</a>
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer">About Us</a>
            <a className="mr-5 hover:text-[#ff7f45] hover:cursor-pointer">Contact Us</a>
          </nav>


          <div className={`flex gap-6 max-lg:flex-col max-lg:gap-3 max-md:pb-5  transition-all max-md:bg-black max-md:w-full max-md:items-center  ${isMobileNav ? 'max-md:-translate-x-0' : 'max-md:-translate-x-[-1000px]'}`}>


          <button className=" text-center  items-center rounded-md bg-[#ff7f45] border-0  px-3 focus:outline-none hover:bg-[#ff9360] text-base mt-4 md:mt-0 max-lg:py-2 max-md:w-[50%]">
            Get a Quote
          </button>
            ...
            <span style={{color: 'white', cursor: 'pointer'}} className=""><a style={{color: 'white', textDecoration: 'none'}} href="mailto:info@affotax.com">info@affotax.com</a></span>
            </div>
            ...
            <span style={{color: 'white', cursor: 'pointer'}} className=""><a style={{color: 'white', textDecoration: 'none'}} href="tel:2081446811" className="">2081446811</a></span>
            </div>
