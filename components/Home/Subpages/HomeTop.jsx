...
export default function HomeTop() {
    return (
        <section className=' text-gray-600 w-full bg-slate-100 pt-8 px-60 max-2xl:px-40 max-xl:px-10  max-lg:px-8 bgImage'>
            <div className=' flex py-24  flex-row max-lg:flex-col max-lg:px-8 max-lg:py-8  items-center justify-between  w-full'>
                <div className='items-start w-[60%] text-left pr-16 flex flex-col  mb-16 md:mb-0  max-lg:w-full max-lg:text-left max-lg:items-center max-lg:pr-0 '>
                ...
                <div className='lg:max-w-2xl w-[40%] max-lg:w-full   '>
                    <img
